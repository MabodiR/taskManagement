...
<?php endif; ?> 	
    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <div class="table-responsive">
            <table class="table" id="manageTask">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody class="taskLists">
                   <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr id="<?php echo e($task->id); ?>">
                    <th scope="row" ><a href="/my-task/<?php echo e($task->id); ?>"><?php echo e($task->id); ?></a></th>
                    ...
                    <td>
                      <select class="form-select action" id="floatingSelect"
                            aria-label="Floating label select example">
                            <option >-</option>
                            <option value="<?php echo e($task->id); ?>">Edit</option>
                            <option value="<?php echo e($task->id); ?>">Delete</option>
                      </select>
                    </tr>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Projects/Calidad/test/resources/views/Managetask.blade.php ENDPATH**/ ?>